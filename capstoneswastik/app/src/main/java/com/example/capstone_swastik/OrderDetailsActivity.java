        ...
        FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener(doc -> {
                    ...
                    if (doc.exists()) {
                        ...
                        tvTotal.setText("Total Amount: ₹ " + total.intValue());
                        ...
                        if (timestamp != null) {
                            ...
                            tvDate.setText("Order Date: " + formattedDate);  // Added title "Date: "
                        }


                        // Status
                        tvStatus.setText("Status: " + (doc.getString("status") != null ? doc.getString("status") : "Pending"));
